...
publish() {
	...
	tag=$(extractyaml "tags" $dir/articles/drafts/$filename.md)
	sed /---/,/---/d $dir/articles/drafts/$filename.md > _
	mv -f _ /tmp/"${filename}.md"
	content=$(smu /tmp/"${filename}.md")
